...
function markContact(i) {
    ...
    if (formerChoosen != null) formerChoosen.classList.remove('Contact_div_choosen');
 ...
 * @param {HTMLElement} bigStage - Html Element work on.
 */
 ...
 */
async function editContactProcess(i) {
    editContact(i);
    await saveContacts();
    clearInputFields();
...
/**
 * Shows confirmation dialogue to delete contact.
 */
...
/**
 * Sorts, saves and shows contactList. Gets called after change in contactsList
 */
